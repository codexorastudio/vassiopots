...
export const products = [
  ...
  // 11. POTA SERIES
  {
    ...
    img: '/products/POTA/POTA-A_BLACK-1.webp',
    thumbnails: [
      '/products/POTA/POTA-A_BLACK-1.webp',
      '/products/POTA/POTA-B_BLACK-1.webp',
      '/products/POTA/POTA-C_BLACK-1.webp',
  ...
  // 12. POPPY SERIES
  {
    ...
    img: '/products/POPPY/POPPY-A_GREY-1.webp',
    thumbnails: [
      '/products/POPPY/POPPY-A_GREY-1.webp',
      '/products/POPPY/POPPY-B_GREY-1.webp',
      '/products/POPPY/POPPY_size_reference.webp'
    ],
    code: 'POPPY',
    color: 'Grey',
    material: 'Premium Fiber-Glass (FRP)',
  ...
  // 13. TULIP SERIES
  {
    ...
    img: '/products/TULIP/TULIP-A_BEIGE-1.webp',
    thumbnails: [
      '/products/TULIP/TULIP-A_BEIGE-1.webp',
      '/products/TULIP/TULIP-E_BEIGE-1.webp',
      '/products/TULIP/TULIP_SIZE_REFERENCE.webp'
    ],
    code: 'TULIP',
    color: 'Beige',
    material: 'Premium Fiber-Glass (FRP)',
  ...
  // 14. LILLY SERIES
  {
    ...
    img: '/products/LILLY/LILLY-A_GREEN-1.webp',
    thumbnails: [
      '/products/LILLY/LILLY-A_GREEN-1.webp',
      '/products/LILLY/LILLY-B_GREY-1.webp',
      '/products/LILLY/LILLY_size_reference.webp'
    ],
    code: 'LILLY',
    color: 'Green / Grey',
    material: 'Premium Fiber-Glass (FRP)',
  ...
  // 15. SUNFLOWER SERIES
  {
    ...
    img: '/products/SUNFLOWER/SUN-B_BEIGE-1.webp',
    thumbnails: [
      '/products/SUNFLOWER/SUN-B_BEIGE-1.webp',
      '/products/SUNFLOWER/SUN-C_BROWN-1.webp',
      '/products/SUNFLOWER/SUN-D_BROWN-1.webp',
      '/products/SUNFLOWER/SUNFLOWER_size_reference.webp'
    ],
    code: 'SUNFLOWER',
    color: 'Beige / Brown',
    material: 'Premium Fiber-Glass (FRP)',
  ...
  // 16. PANSY SERIES
  {
    ...
    img: '/products/PANSY/PANSY-A_BLACK-2.webp',
    thumbnails: [
      '/products/PANSY/PANSY-A_BLACK-2.webp',
      '/products/PANSY/PANSY-B_BLACK-2.webp',
      '/products/PANSY/PANSY-C_BLACK-3.webp',
  ...
  // 17. HOLLYHOCK SERIES
  {
    ...
    img: '/products/HOLLYHOCK/HOLLY-B_BEIGE-1.webp',
    thumbnails: [
      '/products/HOLLYHOCK/HOLLY-B_BEIGE-1.webp',
      '/products/HOLLYHOCK/HOLLYHOCK_size_reference.webp'
    ],
    code: 'HOLLY',
    color: 'Beige',
    material: 'Premium Fiber-Glass (FRP)',
  ...
  // 18. ROSE SERIES
  {
    ...
    img: '/products/ROSE/ROSE-B_RED-1.webp',
    thumbnails: [
      '/products/ROSE/ROSE-B_RED-1.webp',
      '/products/ROSE/ROSE-C_RED-1.webp',
  ...
  // 19. GLORY SERIES
  {
    ...
    img: '/products/GLORY/GLORY-B_GREY-1.webp',
    thumbnails: [
      '/products/GLORY/GLORY-B_GREY-1.webp',
      '/products/GLORY/GLORY-C_GREY-2.webp',
      '/products/GLORY/GLORY-D_GREY-2.webp',
      '/products/GLORY/GLORY-E_GREY-1.webp',
  ...
  // 20. STAR SERIES
  {
    ...
    img: '/products/STAR/STAR-A_GREEN-1.webp',
    thumbnails: [
      '/products/STAR/STAR-A_GREEN-1.webp',
  ...
  // 22. DAISY SERIES
  {
    ...
    img: '/products/DAISY/DAISY-A_YELLOW-2.webp',
    thumbnails: [
      '/products/DAISY/DAISY-A_YELLOW-2.webp',
      '/products/DAISY/DAISY-B_YELLOW-1.webp',
      '/products/DAISY/DAISY-C_YELLOW-3.webp',
  ...
  // 23. ORCHID SERIES
  {
    ...
    img: '/products/ORCHID/ORCHID-A_WHITE-3.webp',
    thumbnails: [
      '/products/ORCHID/ORCHID-A_WHITE-3.webp',
      '/products/ORCHID/ORCHID-B_WHITE-2.webp',
      '/products/ORCHID/ORCHID-C_WHITE-3.webp',
      '/products/ORCHID/ORCHID-D_WHITE-3.webp',
  ...
  // 24. JUPITER SERIES
  {
    ...
    img: '/products/JUPITER/JUPITER-A_BLACK_GREY-4.webp',
    thumbnails: [
      '/products/JUPITER/JUPITER-A_BLACK_GREY-4.webp',
      '/products/JUPITER/JUPITER-B_BLACK_GREY-3.webp',
      '/products/JUPITER/JUPITER-C_BLACK_GREY-4.webp',
      '/products/JUPITER/JUPITER-D_BLACK_GREY-4.webp',
...
export const vases = [
  {
    ...
    insideBox: "1 Ceramic Vessel",
    delivery: "3-5 Working Days",
    payment: "100% Secure Online Payment",
    description: "Sleek matte black ceramic vessel designed for modern dry arrangements.",
  },
  {
    name: "Dune Stoneware Vase",
    img: potBg,
    ...
    delivery: "3-5 Working Days",
    payment: "100% Secure Online Payment",
    description: "Crafted in small batches, this textured stoneware vessel features a raw, organic finish.",
  },
  {
    ...
    delivery: "3-5 Working Days",
    payment: "100% Secure Online Payment",
    description: "Hand-carved solid marble bowl for centerpieces and consoles.",
  },
  {
    name: "Loom Rattan Storage Basket",
    img: potBg,
    ...
    delivery: "3-5 Working Days",
    payment: "100% Secure Online Payment",
    description: "Woven by hand using traditional techniques, perfect outer cover for starter pots.",
  }
];
...
export const auxiliaryProducts = [
  {
    ...
    price: 3999,
    mrp: 4999,
    material: "Silk Petals & Natural Wood Branch",
    dimensions: "Height: 120 cm (4 Feet) Approx.",
    insideBox: "1 Artificial Bougainvillea Tree",
    delivery: "5-7 Working Days",
    payment: "100% Secure Online Payment",
    description: "Vibrant pink faux bougainvillea tree adding everlasting Mediterranean bloom to any room.",
  },
  {
    ...
    price: 1899,
    mrp: 2299,
    material: "Solid Walnut Wood & Heavy Magnet",
    dimensions: "Length: 30 cm, Width: 12 cm",
    insideBox: "1 Floating Shelf & Mounting Kit",
    delivery: "3-5 Working Days",
    payment: "100% Secure Online Payment",
    description: "Minimalist solid wood floating display ledge for small pots and planters.",
  },
  {
    ...
    price: 2399,
    mrp: 2999,
    material: "Silk Fronds & Moulded Trunk",
    dimensions: "Height: 150 cm (5 Feet) Approx.",
    insideBox: "1 Artificial Travellers Palm Tree",
    delivery: "5-7 Working Days",
    payment: "100% Secure Online Payment",
    description: "Architectural tropical palm with broad green fronds.",
  },
  {
    ...
    insideBox: "1 Marble Top & Steel Base Frame",
    delivery: "7-10 Working Days",
    payment: "100% Secure Online Payment",
    description: "Curved round coffee table featuring a polished solid marble top.",
  },
  {
    ...
    price: 949,
    mrp: 1199,
    material: "Solid Brass & Bronze finish",
    dimensions: "Height: 18 cm, Diameter: 8 cm",
    insideBox: "1 Liquid Dispenser",
    delivery: "3-5 Working Days",
    payment: "100% Secure Online Payment",
    description: "Hand-hammered bronze soap/lotion dispenser.",
  },
  {
    ...
    insideBox: "1 Woven Laundry Basket with Lid",
    delivery: "5-7 Working Days",
    payment: "100% Secure Online Payment",
    description: "Structured storage laundry hamper woven from natural hyacinth fibers.",
  }
];
